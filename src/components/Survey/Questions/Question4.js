...
const data=[
{question :'issue ',option :'Criminal matters',next:1,prev:0},
{question :'',option :'uyiiiui',next:2,prev:1},
{question :'What Criminal matter do you want to discuss?',option :'',next:11,prev:1},
            ...
            (counter===1)?
              <div>
                ...
                <div>
                  ...
                  <p>
                    Get bessst guidance from multiple experts suited to your specific legal need.
                  </p>
                ...
                :
                  (
                    (counter === 2) ?
                      <div>
                      <Typography className ={classes.typography}>
                                    What Criminal matter do you want to discuss?
                      </Typography>
                      <form id='1234'>
                        <ul className='inputRadio'>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"
                           value="1"  onChange={()=>changeOption(' Murder',data[counter].next)}/>
                             <label className='container'>
                          Murder</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Physical/Sexual abuse',data[counter].next)}/>
                            <label className='container'>Physical/Sexual abuse</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Bank/Corporation fraud',data[counter].next)}/>
                            <label className='container'>Bank/Corporation fraud</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Theft/Robbery',data[counter].next)}/>
                            <label className='container'>Theft/Robbery</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Harassment',data[counter].next)}/>
                            <label className='container'>Harassment</label>
                          </li>
                        </ul>
                      </form>
                      </div>
