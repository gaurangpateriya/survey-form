...
const data=[
{question : 'issue?',option :'family will matters',next:1,prev:0},
{question : '',option :'uyiiiui',next:2,prev:1},
{question : 'What family matter you need to discuss?',option :'',next:3,prev:1},
...
{question : 'enter email',option :'',name:'',next:20,prev:7},
                ...
                :
                  (
                    (counter === 2) ?
                      <div>
                      <Typography className ={classes.typography}>
                                    What family matter you need to discuss?
                      </Typography>
                      <form id='1234'>
                        <ul className='inputRadio'>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"
                           value="1"  onChange={()=>changeOption(' Marriage registration',data[counter].next)}/>
                             <label className='container'>
                             Marriage registration</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Family dispute',data[counter].next)}/>
                            <label className='container'>Family dispute</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Harassment/abuse',data[counter].next)}/>
                            <label className='container'>Harassment/abuse</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Child Custody/Adoption',data[counter].next)}/>
                            <label className='container'>Child Custody/Adoption</label>
                          </li>
                          <li className='inputradiooption'>
                            <input type="radio"  name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Fasle Cases',data[counter].next)}/>
                            <label className='container'>Fasle Cases</label>
                          </li>
                        </ul>
                      </form>
                      </div>
                          ...
                          (
                            ...
                            <form>
                              <ul className='inputRadio'>
                                ...
                                <li className='inputradiooption'>
                                  <input type="radio"  name="singleSelectRadioButton" czvalue="2" onChange={()=>changeOption('court representaion',12)}/>
