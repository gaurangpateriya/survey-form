...
const data=[
{question:'matter',option :'others',next:1,prev:0},
{question:'',option :'uyiiiui',next:11,prev:1},
{question:'',option :'',next:11,prev:1},
...
{question:'Location where you require the lawyer :',option :'',next:8,prev:5},
{question:'email',name :'', option :'',next:20,prev:6},
{question:'',option :'',next:20,prev:7},
{question:'',option :'',next:10,prev:4},
{question:'Please tell us in detail',option :'',next:3,prev:9},
{question:'What is the status of your case?',option :'',next:4,prev:4},
{question:'',option :'',next:6,prev:5}]
                                    ...
                                    <div>
                                      ...
                                      <form>
                                        <ul className='inputRadio'>
                                          ...
                                          <li className='inputradiooption'>
                                            <input type="radio"  id="Extramarital"    name="singleSelectRadioButton"value="2" onChange={()=>changeOption('Best in class',5)}/>
